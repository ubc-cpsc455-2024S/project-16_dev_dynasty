...
import { updateDocumentAsync, fetchDocumentsByHouseId } from '../redux/documents/thunksDocuments';
import {
  Box,
  Button,
  Container,
...
const EditHouseDocumentPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await dispatch(updateDocumentAsync({ houseId: id, documentId, documentData })).unwrap();
  ...
  return (
    <Navbar>
      <Container>
        <Header1 title={<HouseHeader npl="Edit Document" />} />
